...
if ( ! function_exists( 'surfarama_theme_customizer' ) ) :
	...
	function surfarama_theme_customizer( $wp_customize ) {
		...
		$wp_customize->add_setting( 'surfarama_link_color' );
		...
		$wp_customize->add_setting( 'surfarama_logo' );
		...
		$wp_customize->add_setting( 'surfarama_facebook' );
		...
		$wp_customize->add_setting( 'surfarama_twitter' );
		...
		$wp_customize->add_setting( 'surfarama_google' );
		...
		$wp_customize->add_setting( 'surfarama_pinterest' );
		...
		$wp_customize->add_setting( 'surfarama_linkedin' );
		...
		$wp_customize->add_setting( 'surfarama_youtube' );
		...
		$wp_customize->add_setting( 'surfarama_tumblr' );
		...
		$wp_customize->add_setting( 'surfarama_instagram' );
		...
		$wp_customize->add_setting( 'surfarama_flickr' );
		...
		$wp_customize->add_setting( 'surfarama_vimeo' );
		...
		$wp_customize->add_setting( 'surfarama_yelp' );
		...
		$wp_customize->add_setting( 'surfarama_rss' );
		...
		$wp_customize->add_setting( 'surfarama_cat_show_link' );
		...
		$wp_customize->add_setting( 'surfarama_imgborder' );
